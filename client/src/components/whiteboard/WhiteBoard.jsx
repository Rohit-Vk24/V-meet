...
import socket from '../../services/socket'; // Import the socket instance
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faPen, faEraser, faUndo, faRedo, faDownload } from '@fortawesome/free-solid-svg-icons'; // Import faDownload
import './Whiteboard.css';
...
const Whiteboard = () => {
  ...
  const downloadImage = () => {
    ...
    link.href = dataUrl;
    link.download = 'whiteboard.png'; // Set the default download file name
    link.click();
  };
  ...
  return (
    <div className="whiteboard-container">
      <div className="toolbar">
        ...
        <button onClick={downloadImage}> {/* Add download button */}
